...
function(locate_matlab_root)
  ...
  if (UNIX)
	...
	if (NOT MATLAB_ROOT_DIR_)
		file(GLOB MATLAB_ROOT_DIR_ ${DIR_}/*MATLAB*)
	endif()
      if (MATLAB_ROOT_DIR_)
	file(GLOB MATLAB_ROOT_DIR1 ${MATLAB_ROOT_DIR_}/R20*)# path is e.g /usr/local/MATLAB/R2011a
	if(MATLAB_ROOT_DIR1)
		SET(MATLAB_ROOT_DIR_ ${MATLAB_ROOT_DIR1})
	endif()
...
function(locate_matlab_components MATLAB_ROOT_DIR)
  ...
  message(STATUS "MATLAB_MEXEXT_SCRIPT_ path:" ${MATLAB_ROOT_DIR}/bin)
  find_file(MATLAB_MEXEXT_SCRIPT_ NAMES mexext mexext.bat PATHS ${MATLAB_ROOT_DIR}/bin NO_DEFAULT_PATH)
  message(STATUS "MATLAB_MEXEXT_SCRIPT_:" ${MATLAB_MEXEXT_SCRIPT_})
...
if(WIN32)
  ...
  find_library(MATLAB_LIB_ENG_ eng PATHS ${MATLAB_LIBRARY_DIRS_} NO_DEFAULT_PATH)
  set(MATLAB_LIBRARIES_ ${MATLAB_LIB_MX_} ${MATLAB_LIB_MEX_} ${MATLAB_LIB_MAT_} ${MATLAB_LIB_ENG_})

  # get the include path
  find_path(MATLAB_INCLUDE_DIRS_ mex.h ${MATLAB_ROOT_DIR}/extern/include NO_DEFAULT_PATH)
