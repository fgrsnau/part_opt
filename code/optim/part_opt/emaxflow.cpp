...
double emaxflow(const num_array<int, 2>  & E, const num_array<c_type, 2> & f1, const num_array<c_type, 3> & f2, num_array<int, 1> & x){
	...
	typedef c_type tcap;
	typedef typename tflow<tcap>::type tflow;
...
template double emaxflow(const num_array<int, 2>  &, const num_array<int, 2> &, const num_array<int, 3> &, num_array<int, 1> &);
template double emaxflow(const num_array<int, 2>  &, const num_array<float, 2> &, const num_array<float, 3> &, num_array<int, 1> &);