...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
	...
	stat - double struct - various values
	*/
	...
	//debug::stream << "chk1\n";
	mx_array<c_type,2> f1(prhs[1]);
	//debug::stream << "chk1\n";
	mx_array<c_type, 3> f2(prhs[2]);
	//debug::stream << "chk1\n";
